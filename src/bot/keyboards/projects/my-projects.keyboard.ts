...
export const projectsMenu = new Menu<Context>("projects-menu")
  ...
  .text("Групповое ведение", async (ctx) => {
    await ctx.reply(
      `Следующий поток группового ведения стартует 20 ноября. Это уникальная возможность комплексно поработать над своим здоровьем под моим присмотром по доступной цене. 
